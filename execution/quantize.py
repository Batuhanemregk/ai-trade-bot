...
class Quantizer:
    ...
    def quantize_size(self, size: Union[float, Decimal]) -> float:
        ...
        lot_decimal = Decimal(str(self.config.lot_size))
...
def quantize_price(symbol_or_price: Union[str, float], price_or_tick_size: Union[float, None] = None) -> float:
    """
...
def quantize_size(symbol_or_size: Union[str, float], size_or_lot_size: Union[float, None] = None) -> float:
    """
